...
public final class RandomForestMP {
	private static class DataToLabelPoint implements Function<String,
	LabeledPoint> {
	...
	private static class DataToPoint implements Function<String,
	Vector> {
	private static final Pattern SPACE = Pattern.compile(",");
    ...
    public static void main(String[] args) {
        ...
        JavaRDD<LabeledPoint> train =
        		sc.textFile(training_data_path).map(new DataToLabelPoint());
        JavaRDD<Vector> test =
        		sc.textFile(test_data_path).map(new DataToPoint());
